...
//
// aria-hidden="true" por defecto: en todo el proyecto estos íconos van
// junto a un texto visible o dentro de un botón que ya tiene su propio
// title/aria-label — el ícono en sí no aporta información que un lector
// de pantalla deba anunciar aparte. Si algún día se necesita un ícono
// que SÍ sea la única pista de significado (raro), se puede pasar
// aria-hidden={false} explícito en ese uso puntual.
const base = {
  viewBox: "0 0 24 24",
  fill: "none",
  stroke: "currentColor",
